...
namespace ICL.DWH.Backend.Core.Migrations
{
    ...
    [Migration("20230208144024_create_cms_entities")]
    partial class create_cms_entities
    {
            ...
            modelBuilder.Entity("ICL.DWH.Backend.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 2, 8, 9, 40, 24, 328, DateTimeKind.Local).AddTicks(4748),
                            RoleName = "HQ.User"
                        },
                        new
                        {
                            Id = new Guid("64dbfc18-5508-4af5-aecd-e98cd731fd15"),
                            CreateDate = new DateTime(2023, 2, 8, 9, 40, 24, 328, DateTimeKind.Local).AddTicks(4776),
                            RoleName = "Country.User"
                        },
                        new
                        {
                            Id = new Guid("44b8bcf1-f444-4eb0-958e-64c77f24e5c7"),
                            CreateDate = new DateTime(2023, 2, 8, 9, 40, 24, 328, DateTimeKind.Local).AddTicks(4779),
