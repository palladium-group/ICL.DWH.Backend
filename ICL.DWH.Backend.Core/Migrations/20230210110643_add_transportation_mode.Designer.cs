...
namespace ICL.DWH.Backend.Core.Migrations
{
    ...
    [Migration("20230210110643_add_transportation_mode")]
    partial class add_transportation_mode
    {
            ...
            modelBuilder.Entity("ICL.DWH.Backend.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 2, 10, 14, 6, 42, 796, DateTimeKind.Local).AddTicks(771),
                            RoleName = "HQ.User"
                        },
                        new
                        {
                            Id = new Guid("64dbfc18-5508-4af5-aecd-e98cd731fd15"),
                            CreateDate = new DateTime(2023, 2, 10, 14, 6, 42, 796, DateTimeKind.Local).AddTicks(796),
                            RoleName = "Country.User"
                        },
                        new
                        {
                            Id = new Guid("44b8bcf1-f444-4eb0-958e-64c77f24e5c7"),
                            CreateDate = new DateTime(2023, 2, 10, 14, 6, 42, 796, DateTimeKind.Local).AddTicks(801),
